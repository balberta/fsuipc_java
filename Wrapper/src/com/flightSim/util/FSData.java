...
public class FSData {
    ...
    public byte getByte(int aOffset)
    {
        ...
        FSWrapper.ReadData(aOffset,1,data);
        return data[0];
    }
    ...
    public short getShort(int aOffset)
    {
        ...
        FSWrapper.ReadData(aOffset,2,data);
        buf.put(data,0,2);
    ...
    public int getInt(int aOffset)
    {
        ...
        FSWrapper.ReadData(aOffset,4,data);
        buf.put(data,0,4);
        return buf.getInt(0);
    }
    ...
    public long getLong(int aOffset)
    {
        ...
        FSWrapper.ReadData(aOffset,8,data);
        buf.put(data,0,8);
    ...
    public String getString(int aOffset,int aLength)
    {
        ...
        FSWrapper.ReadData(aOffset,aLength,data);
